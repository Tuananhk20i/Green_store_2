...
export default function LatestNewsPage() {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero */}
      <section className="relative">
        <div className="h-56 sm:h-72 lg:h-96 relative">
          <Image
            src="https://images.unsplash.com/photo-1482192505345-5655af888cc4?auto=format&fit=crop&w=1400&q=60"
            alt="Tin tức Green Store"
            fill
            priority
          ...
          <div className="relative z-10 flex items-center justify-center h-full">
            <div className="text-center text-white px-4">
              ...
              <p className="mt-2 text-sm sm:text-base opacity-90">
                Cập nhật tin tức, mẹo vặt và thông báo từ Green Store
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white">
          <div className="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-600 flex items-center justify-between">
            <nav className="flex items-center gap-2">
              ...
              <span className="text-gray-300">&gt;</span>
              <Link href="/news" className="hover:text-lime-600">
                TIN TỨC
              </Link>
              <span className="text-gray-300">&gt;</span>
