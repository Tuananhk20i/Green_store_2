        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <button className="inline-block bg-gray-800 text-white px-5 py-2 rounded shadow">TÌM HIỂU THÊM</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 bg-lime-500/80 border border-lime-500 rounded text-center">
              ...
              <div className="mt-4">
                <Link href="/products" className="inline-block border border-white px-4 py-2 text-sm">MUA NGAY</Link>
              </div>
            </div>
